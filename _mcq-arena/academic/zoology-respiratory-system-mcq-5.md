...
title: "HSC Biology 2nd Paper Chapter 5: Respiratory System MCQ"
...
node_id: mcq-academic-respiratory-system-5
...
<div class="neural-quiz-wrapper">
  <div class="quiz-card">
    <div class="quiz-header">
      <h2>🫁 শ্বসনতন্ত্র কুইজ টেস্ট</h2>
      <div class="quiz-timer" id="timer4">⏱️ 15:00</div>
      <div class="progress-wrap">
        <div class="progress-bar" id="progressBar4"></div>
      </div>
      <div class="progress-text" id="progressText4">0 / 8 Answered</div>
    </div>

    <div class="quiz-body" id="quizBody4">
      <div class="q" data-a="1">
        <div class="q-text">১. প্রশ্বাস বায়ুতে কার্বন ডাই-অক্সাইডের পরিমাণ কত?</div>
        <div class="opts">
          <div class="opt">০.৪%</div>
          <div class="opt">০.০৪%</div>
          <div class="opt">২০%</div>
          <div class="opt">৪.০%</div>
        </div>
        <div class="exp">✔ সঠিক: ০.০৪% (নিঃশ্বাসে থাকে ৪%)।</div>
      </div>

      <div class="q" data-a="2">
        <div class="q-text">২. সারফেকট্যান্ট কোথায় ক্ষরিত হয়?</div>
        <div class="opts">
          <div class="opt">স্বরযন্ত্রে</div>
          <div class="opt">শ্বাসনালিতে</div>
          <div class="opt">অ্যালভিওলাসে</div>
          <div class="opt">ব্রঙ্কাসে</div>
        </div>
        <div class="exp">✔ সঠিক: অ্যালভিওলাসের প্রাচীর থেকে (পৃষ্ঠটান কমাতে)।</div>
      </div>

      <div class="q" data-a="3">
        <div class="q-text">৩. সাইনুসাইটিসের প্রধান লক্ষণ কোনটি?</div>
        <div class="opts">
          <div class="opt">কাশি</div>
          <div class="opt">বমি</div>
          <div class="opt">জ্বর</div>
          <div class="opt">তীব্র মাথাব্যথা</div>
        </div>
        <div class="exp">✔ সঠিক: মাথাব্যথা।</div>
      </div>

      <div class="q" data-a="0">
        <div class="q-text">৪. কোথায় সেরাস ফ্লুইড পাওয়া যায়?</div>
        <div class="opts">
          <div class="opt">ফুসফুসের প্লুরা গহ্বরে</div>
          <div class="opt">ব্রঙ্কাসে</div>
          <div class="opt">অ্যালভিওলাসে</div>
          <div class="opt">ট্রাকিয়ায়</div>
        </div>
        <div class="exp">✔ সঠিক: ফুসফুসের দুই স্তরী প্লুরা পর্দার মাঝে ঘর্ষণ রোধ করতে।</div>
      </div>

      <div class="q" data-a="3">
        <div class="q-text">৫. দু’চোখের মাঝের সাইনাস কোনটি?</div>
        <div class="opts">
          <div class="opt">ম্যাক্সিলারি</div>
          <div class="opt">ফ্রন্টাল</div>
          <div class="opt">স্কেটেনয়েড</div>
          <div class="opt">এথময়েড</div>
        </div>
        <div class="exp">✔ সঠিক: এথময়েড (Ethmoid) সাইনাস।</div>
      </div>

      <div class="q" data-a="1">
        <div class="q-text">৬. টিস্যুতে কার্বন ডাই-অক্সাইডের আংশিক চাপ ($) কত?</div>
        <div class="opts">
          <div class="opt">৪০ mmHg</div>
          <div class="opt">৪৬ mmHg</div>
          <div class="opt">৬০ mmHg</div>
          <div class="opt">৭০ mmHg</div>
        </div>
        <div class="exp">✔ সঠিক: প্রায় ৪৬ mmHg।</div>
      </div>

      <div class="q" data-a="2">
        <div class="q-text">৭. নিচের কোনটি সঠিক?</div>
        <div class="opts">
          <div class="opt">ডান ব্রঙ্কাস ছোট ও সরু</div>
          <div class="opt">বাম ব্রঙ্কাস খাটো ও চওড়া</div>
          <div class="opt">ডান ব্রঙ্কাস খাটো ও চওড়া</div>
          <div class="opt">হাইলাম দিয়ে বের হয়</div>
        </div>
        <div class="exp">✔ সঠিক: ডান ব্রঙ্কাস অপেক্ষাকৃত খাটো এবং চওড়া।</div>
      </div>

      <div class="q" data-a="1">
        <div class="q-text">৮. COPD এর পূর্ণরূপ কী?</div>
        <div class="opts">
          <div class="opt">Chronic Obstructive Pleural Disease</div>
          <div class="opt">Chronic Obstructive Pulmonary Disease</div>
          <div class="opt">Central Obstructive Pulmonary Disease</div>
          <div class="opt">Chronic Obsessive Pulmonary Disease</div>
        </div>
        <div class="exp">✔ সঠিক: Chronic Obstructive Pulmonary Disease।</div>
      </div>

    </div>

    <div class="quiz-foot">
      <button class="btn-submit" onclick="submitQuiz('quizBody4', 'scoreBoard4', 'progressBar4')">Submit Assessment</button>
      <button class="btn-restart" onclick="location.reload()">Restart</button>
      <div class="score-board" id="scoreBoard4"></div>
    </div>
  </div>
</div>
...
document.addEventListener("DOMContentLoaded", () => {
  initQuiz('quizBody4', 'timer4', 'progressBar4', 'progressText4', 900);
});
</script>
