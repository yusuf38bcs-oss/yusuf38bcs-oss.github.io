...
<head>
    ...
    <title>বিস্তারের পরিমাপ - Bio Stat Boss</title>
    <style>
        ...
        /* কন্টেইনার এবং অ্যাকর্ডিয়ন স্টাইল */
        .biostats-container { 
            background: white; 
            border-radius: 12px; 
        ...
        .biostats-container .content { padding: 20px; line-height: 1.8; color: #444; font-size: 1em; text-align: left; }
        .formula-box { background: #f8fbff; border-left: 5px solid #3498db; padding: 15px; margin: 15px 0; border-radius: 4px; font-size: clamp(0.9em, 2vw, 1.1em); color: #2980b9; font-weight: bold; overflow-x: auto; text-align: center; }
        .reference-box { background: #fff3cd; border-left: 5px solid #ffc107; padding: 15px; margin: 20px 0; border-radius: 4px; font-size: 0.95em; color: #856404; text-align: left; }
...
<div class="bio-post-wrapper">
    ...
    <div class="bio-header-section">
        ...
        <p>জীবপরিসংখ্যানে উপাত্তের নির্ভরযোগ্যতা যাচাইয়ের সহজ পাঠ | লেখক: <strong>Bio Stat Boss</strong></p>
    </div>

    <div class="reference-box">
        <strong>📚 রেফারেন্স নোট:</strong> এই ব্লগের সকল গাণিতিক সূত্র আন্তর্জাতিকভাবে স্বীকৃত মেডিকেল স্ট্যাটিস্টিক্স বই <em>"Fundamentals of Biostatistics" (Bernard Rosner)</em> এবং <em>"Biostatistics: A Foundation for Analysis in the Health Sciences" (Wayne W. Daniel & Chad L. Cross)</em> থেকে ক্রসচেক করা হয়েছে।
    </div>
    ...
    <div class="biostats-container">
        ...
        <details open>
            ...
            <div class="content">
                ...
                <p>যেমন: দুটি রোগীর গ্রুপের গড় বয়স ৩০ বছর হতে পারে, কিন্তু এক গ্রুপে হয়তো সবার বয়স ২৯- can ৩১ এর মধ্যে, আর অন্য গ্রুপে হয়তো ২০-৪০ এর মধ্যে! এই ভিন্নতা বা ছড়ানো অবস্থা পরিমাপ করার জন্যই <strong>বিস্তারের পরিমাপ বা Measures of Dispersion</strong> ব্যবহার করা হয়।</p>
            </div>
        </details>
        ...
        <details>
            ...
            <div class="content">
                ...
                <p><strong>সীমাবদ্ধতা:</strong> এটি শুধুমাত্র দুটি প্রান্তিক মানের (Extreme values) ওপর নির্ভর করে। ডেটাসেটের মাঝখানের উপাত্তগুলোর মধ্যে কেমন পরিবর্তন হচ্ছে, তা পরিসর দিয়ে বোঝা সম্ভব নয়।</p>
            </div>
        </details>
        ...
        <details>
            ...
            <div class="content">
                <p>ভেদাঙ্ক আমাদের জানায় উপাত্তগুলো তাদের গড় মান (Mean) থেকে কতটুকু দূরে আছে। গাণিতিকভবে, গড় থেকে প্রতিটি উপাত্তের দূরত্বের বর্গের গড়কে ভেদাঙ্ক বলে। জীবপরিসংখ্যানে আমরা সাধারণত 'নমুনা' (Sample) নিয়ে কাজ করি, তাই $(n-1)$ দ্বারা ভাগ করা হয় (যাকে Degrees of Freedom বলা হয়)।</p>
                <div class="formula-box">
                    $$s^2 = \frac{\sum (X - \bar{X})^2}{n - 1}$$
                </div>
                <p><em>(Rosner এবং Daniel & Cross উভয়ের মতেও, পপুলেশনের বদলে নমুনার জন্য 'n-1' ব্যবহার করাটা আনবায়াসড বা নিরপেক্ষ ফলাফল দেয়।)</em></p>
            </div>
        </details>
        ...
        <details>
            ...
            <div class="content">
                ...
                <p><strong>কেন এটি সবচেয়ে জনপ্রিয়?</strong> কারণ SD-এর একক মূল উপাত্তের এককের সমান (যেমন: সেমি, কেজি বা বছর)। এটি একটি নির্দিষ্ট গ্রুপের ভেতরের প্রাকৃতিক ভিন্নতা (Natural Variation) প্রকাশ করে।</p>
            </div>
        </details>
        ...
        <details>
            ...
            <div class="content">
                ...
                <p><strong>SD বনাম SE:</strong> গবেষণাপত্রে যখন কোনো ডেটাসেটের বৈশিষ্ট্য বর্ণনা করা হয়, তখন <strong>$\text{Mean} \pm \text{SD}$</strong> লেখা হয়। কিন্তু যখন কোনো গবেষণার ফলাফলের নির্ভরযোগ্যতা প্রকাশ করা হয়, তখন <strong>$\text{Mean} \pm \text{SE}$</strong> ব্যবহার করা হয়।</p>
            </div>
        </details>
        ...
        <details>
            ...
            <div class="content">
                ...
                <p><strong>ধাপ ১: গড় ($\bar{X}$) নির্ণয়</strong><br>
                $$\bar{X} = \frac{৮+১০+১২+১৪+১৬}{৫} = \frac{৬০}{৫} = ১২ \text{ সেমি}$$</p>
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr><td>১২</td><td>$১২ - ১২ = 0$</td><td>0</td></tr>
                            <tr><td>১৪</td><td>$১৪ - ১২ = ২$</td><td>৪</td></tr>
                            <tr><td>১৬</td><td>$১৬ - ১২ = ৪$</td><td>১৬</td></tr>
                            <tr style="background:#f1f4f8; font-weight:bold;">
                                <td>মোট ($n = ৫$)</td>
                                <td>0 (নির্ভুলতার প্রমাণ)</td>
                                <td>$\sum (X - \bar{X})^2 = ৪0$</td>
                            </tr>
                        </tbody>
                    </table>
                </div>

                <p><strong>ধাপ ৩: চূড়ান্ত হিসাব (Final Calculations)</strong></p>
                <ul>
                    <li><strong>ভেদাঙ্ক (Variance, $s^2$):</strong> $\frac{৪0}{৫ - ১} = \frac{৪0}{৪} = ১০$</li>
                    <li><strong>পরিমিত ব্যবধান (SD, $s$):</strong> $\sqrt{১০} \approx ৩.১৬ \text{ সেমি}$</li>
                    <li><strong>আদর্শ বিভ্রম (SE):</strong> $\frac{৩.১৬}{\sqrt{৫}} \approx ১.৪১ \text{ সেমি}$</li>
                </ul>

                <div class="result-box">
                    <h3 style="margin-top: 0; color: #27ae60;">ফলাফল উপস্থাপন (Reporting the Data)</h3>
                    <p style="font-size: 1.2em; margin-bottom: 0;">গড় উচ্চতা = $১২ \pm ১.৪১ \text{ সেমি}$ ($\text{Mean} \pm \text{SE}$)</p>
                    <p style="font-size: 0.9em; color: #7f8c8d; margin-top: 5px;">[গবেষণাপত্রে (Research Paper) এভাবেই ডেটা রিপোর্ট করা হয়]</p>
                </div>
            </div>
        </details>
