...
<div class="system-block-layer" style="background: #090d16; border: 1px solid rgba(255,255,255,0.02); padding: 2rem; border-radius: 12px; margin: 2rem 0; box-shadow: 0 4px 20px rgba(0,0,0,0.25);">
  ...
  <p style="color: #94a3b8; margin-bottom: 1.5rem; line-height: 1.6;">সহসম্বন্ধ হলো দুটি বন্ধুর মিতালীর মতো। তারা একে অপরের ওপর কতটা প্রভাব ফেলে এবং একসাথে কোন দিকে হাঁটে, কোরিলেশন মূলত সেটুকু পরিমাপ করে।</p>
...
<div class="system-block-layer" style="background: #090d16; border: 1px solid rgba(255,255,255,0.02); padding: 2rem; border-radius: 12px; margin: 2rem 0; box-shadow: 0 4px 20px rgba(0,0,0,0.25);">
  ...
  <div class="math-model-sub-card" style="background: #131c2e; border: 1px solid rgba(255,255,255,0.02); padding: 1.5rem; border-radius: 8px; margin-bottom: 1.5rem; border-top: 4px solid #3b82f6;">
    ...
    <ul style="padding-left: 1.25rem; color: #94a3b8; display: flex; flex-direction: column; gap: 0.4rem; font-size: 0.9rem;">
      <li><strong style="color: #e2e8f0;">$Y$ (Dependent Variable):</strong> নির্ভরশীল চলক—যার মান আমরা প্রডিক্ট করতে চাই (যেমন: ফসলের চূড়ান্ত ফলন)।</li>
    ...
    <table class="premium-matrix-table" style="width: 100%; border-collapse: collapse; font-size: 0.95rem; text-align: center; border: 1px solid rgba(255,255,255,0.05);">
      <thead>
        <tr style="background-color: #131c2e;">
          <th style="color: #00d4b2; padding: 12px; font-weight: 700;">উচ্চতা ($X$)</th>
          <th style="color: #ffffff; padding: 12px; font-weight: 700;">ওজন ($Y$)</th>
      ...
      <tbody>
        ...
        <tr style="background-color: rgba(255,255,255,0.01);"><td>১৬০</td><td>৬০</td><td>২৫৬০০</td><td>৩৬০০</td><td>৯৬০০</td></tr>
        <tr><td>১৭০</td><td>৭০</td><td>২৮৯০০</td><td>৪৯০০</td><td>১১৯০০</td></tr>
        <tr style="background-color: rgba(255,255,255,0.01);"><td>১৮০</td><td>৮০</td><td>৩২৪০০</td><td>৬৪০০</td><td>১৪৪০০</td></tr>
...
<div class="system-block-layer" style="background: #090d16; border: 1px solid rgba(255,255,255,0.02); padding: 2rem; border-radius: 12px; margin: 2rem 0; box-shadow: 0 4px 20px rgba(0,0,0,0.25);">
  <h3 style="color: #ffffff; font-size: 1.4rem; font-weight: 800; margin-top: 0; margin-bottom: 1.5rem;"><span style="color: #00d4b2;">৫️⃣</span> কোরিলেশন বনাম রিগ্রেশন ম্যাট্রিক্স</h3>
  
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
    <div style="background: #131c2e; padding: 1.5rem; border-radius: 8px; border-top: 4px solid #3b82f6;">
      <strong style="color: #ffffff; font-size: 1.1rem; display: block; margin-bottom: 0.75rem;">🔍 সহসম্বন্ধ (Correlation)</strong>
      <ul style="padding-left: 1.25rem; color: #94a3b8; display: flex; flex-direction: column; gap: 0.5rem; margin: 0; font-size: 0.9rem; line-height: 1.5;">
        ...
        <li>এখানে কোনো স্বাধীন বা নির্ভরশীল চলকের বৈষম্য বা বাধ্যবাধকতা নেই। $X$ ও $Y$ অদলবদল করলেও $r$-এর মান একই থাকবে ($r_{xy} = r_{yx}$)।</li>
        <li>এর কোনো সুনির্দিষ্ট পরিমাপের একক নেই, এটি একটি বিশুদ্ধ অনুপাত সংখ্যা।</li>
      </ul>
    </div>
    
    <div style="background: #131c2e; padding: 1.5rem; border-radius: 8px; border-top: 4px solid #10b981;">
      <strong style="color: #ffffff; font-size: 1.1rem; display: block; margin-bottom: 0.75rem;">📈 নির্ভরক (Regression)</strong>
      <ul style="padding-left: 1.25rem; color: #94a3b8; display: flex; flex-direction: column; gap: 0.5rem; margin: 0; font-size: 0.9rem; line-height: 1.5;">
        <li>এটি একটি গাণিতিক ফাংশন যার মাধ্যমে চলক দুটির কার্যকারণ প্রকৃতির ওপর ভিত্তি করে অজানা মান ফোরকাস্ট করা যায়।</li>
        <li>এখানে স্বাধীন ও নির্ভরশীল চলক কঠোরভাবে সুনির্দিষ্ট। চলক অদলবদল করলে সম্পূর্ণ সমীকরণ এবং ঢাল বদলে যাবে।</li>
        <li>এটি পরম এককে পরিমাপ করা যায় এবং এর সাহায্যে গ্রাফে সেরা মানানসই সরলরেখা (Line of Best Fit) অঙ্কন করা সম্ভব।</li>
      </ul>
    </div>
  </div>
</div>
...
<div class="critical-thinking-matrix" style="background: #0b1324; border: 2px dashed rgba(0, 212, 178, 0.3); padding: 25px; border-radius: 12px; margin-top: 30px; box-shadow: 0 4px 20px rgba(0,0,0,0.4);">
  ...
  <p style="color: #ffffff; font-weight: 700; margin-bottom: 0.5rem;">ক্রিটক্যাল থিংকিং চ্যালেঞ্জ:</p>
  <p style="color: #cbd5e1; line-height: 1.7; margin: 0;">
    এই গাণিতিক ফলাফলের ওপর ভিত্তি করে তুমি কি এই পলিসিগত সিদ্ধান্তে নেবে যে আইসক্রিম খাওয়া বাড়ার কারণেই হাঙ্গর মানুষকে বেশি আক্রমণ করছে? যদি তা না হয়, তবে এখানে লুকিয়ে থাকা তৃতীয় কোন বায়োলজিক্যাল ও এনভায়রনমেন্টাল চলকটি (Confounding Variable) পর্দার আড়াল থেকে এই দুই চলকের স্ট্রং কোরিলেশন নিয়ন্ত্রণ করছে? জীববিজ্ঞানের আলোকে তোমার যুক্তিনির্ভর উত্তর দাও!
  </p>
</div>
