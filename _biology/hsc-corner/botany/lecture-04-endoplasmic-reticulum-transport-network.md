...
<h3>২. ER-এর প্রধান গঠনগত অংশ</h3>
  ...
  <div class="table-wrap">
    <table>
      ...
      <tbody>
        ...
        <tr><td>Transport vesicle</td><td>Small membrane-bound bud</td><td>ER থেকে Golgi body-তে cargo বহন করে</td></tr>
      </tbody>
    </table>
  </div>
</div>
...
<section class="lbfl-card summary">
  <ul class="lbfl-list">
    ...
    <li>ER flattened cisternae, tubules, lumen এবং transport vesicle-এর মাধ্যমে organized system তৈরি করে।</li>
