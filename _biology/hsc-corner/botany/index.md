...
<div class="manifold-header">
  <h1>🌿 উদ্ভিদবিজ্ঞান (HSC Botany)</h1>
  <p>Data Node: Cellular Biology & The Central Dogma</p>
</div>

<p style="color: #cbd5e1; font-size: 1.1rem; line-height: 1.7; text-align: center; max-width: 800px; margin: 0 auto 2.5rem auto;">
  Investigate the structural engineering of cell organelles, DNA mechanics, and plant physiology. Select a module below to initialize.
</p>
...
<div class="neural-grid">
  ...
  {% else %}
    <p style="color: #ef4444; text-align: center; width: 100%;">No data logs found in the Botany matrix.</p>
  {% endfor %}
</div>
