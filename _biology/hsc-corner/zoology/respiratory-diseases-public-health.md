...
tags:
  ...
  - Public Health
  - HSC Zoology
node_id: hsc-zoology-respiratory-diseases-public-health
...
শ্বসনতন্ত্রের রোগ বুঝতে হলে আগে জানতে হবে কোন অংশ আক্রান্ত হচ্ছে। নাক, সাইনাস, গলা ও স্বরযন্ত্র আক্রান্ত হলে তা সাধারণত **upper respiratory tract** সমস্যা হিসেবে দেখা হয়। ট্রাকিয়া, ব্রঙ্কাস, ব্রঙ্কিউল, অ্যালভিওলাই ও ফুসফুস আক্রান্ত হলে তা **lower respiratory tract** বা lung disease হিসেবে গুরুতর হতে পারে।
...
| Region | Main structures | Common problems |
|---|---|---|
| Upper respiratory tract | nose, sinus, pharynx, larynx, ear connection through Eustachian tube | sinusitis, pharyngitis, laryngitis, otitis media, flu-like illness |
| Conducting lower airway | trachea, bronchi, bronchioles | tracheitis, bronchitis, asthma, COPD |
| Respiratory zone | alveoli, alveolar ducts, capillaries | pneumonia, emphysema, fibrosis, gas-exchange failure |
| Pleural region | visceral/parietal pleura | pleurisy, pleural pain, effusion awareness |

## 2. Sinusitis: সাইনাসের প্রদাহ

**Sinusitis** হলো sinus mucosa-এর inflammation। কারণ হতে পারে virus, bacteria, fungus, allergy অথবা blocked drainage.

### Site-based pain logic

| Sinus | Possible pain area |
|---|---|
| Maxillary sinus | cheek, teeth, upper jaw, head |
| Frontal sinus | forehead, above eyes, head |
| Ethmoid sinus | between eyes, head |
| Sphenoid sinus | deep head pain, behind eyes |
...
গলবিলের সঙ্গে middle ear-এর সংযোগ থাকে **Eustachian tube** দিয়ে। Upper respiratory infection হলে inflammation এই tube-কে block করতে পারে। তখন middle ear-এ fluid বা infection জমে **otitis media** হতে পারে।

### Why respiratory chapter includes ear infection

কারণ nose-throat-ear একই mucosal passage system-এর সঙ্গে যুক্ত। তাই শিশুর সর্দি-কাশির পর ear pain দেখা যেতে পারে।

## 4. Laryngitis: Voice Box Inflammation

**Laryngitis** হলো larynx বা vocal cord region-এর inflammation।
...
Vocal cord vibration স্বাভাবিক না হলে sound production পরিবর্তিত হয়। তাই voice change laryngeal involvement-এর clinical clue হতে পারে।

## 5. Bronchitis: Bronchial Inflammation

**Bronchitis** হলো bronchi-এর mucosal inflammation। এটি acute বা chronic হতে পারে।

### Mechanism

```text
Irritation / infection / smoke
  ↓
Bronchial mucosa inflamed
  ↓
Mucus secretion increases
  ↓
Cilia clearance decreases
  ↓
Cough + sputum + airflow difficulty
```
...
```text
Bacteria / virus / fungus reaches lung
  ↓
Alveolar inflammation
  ↓
Fluid or pus fills air sacs
  ↓
Diffusion distance increases
  ↓
O₂ entry into blood decreases
  ↓
...
**Tuberculosis (TB)** সাধারণত *Mycobacterium tuberculosis* bacteria দ্বারা হয়। এটি lung-এ বেশি দেখা যায়, কিন্তু body-এর অন্য অংশেও হতে পারে।

### Active TB symptom logic
...
Flu হলো influenza virus দ্বারা সৃষ্ট contagious respiratory illness, যা nose, throat এবং কখনও lungs আক্রান্ত করতে পারে।

### Common symptoms

- sudden feverish feeling/chills
- cough
- sore throat
- runny/stuffy nose
- body ache
...
- indoor air cleaning/ventilation

## 9. Asthma: Reversible Airway Narrowing

**Asthma** হলো chronic airway condition যেখানে airway inflammation এবং narrowing episodically হয়। Triggers হতে পারে pollen, exercise, viral infection, cold air, smoke, dust, stress ইত্যাদি।
...
**COPD** বা chronic obstructive pulmonary disease হলো airflow limitation-এর chronic condition। এর দুইটি বড় component হলো chronic bronchitis ও emphysema.

### 10.1 Chronic bronchitis

Repeated irritation/inflammation bronchial lining-এ thick mucus তৈরি করে। ফলে airflow কমে এবং chronic cough/sputum হয়।

### 10.2 Emphysema

Emphysema-তে alveolar wall damage হয়। Air sacs elastic recoil হারায়, gas-exchange surface কমে এবং air trapping হয়।
...
Alveolar wall damage
  ↓
Air sacs enlarge and lose elasticity
  ↓
...
**Pleurisy** হলো pleural membrane-এর inflammation। Pleura শ্বাসের সময় chest wall ও lungs-এর friction কমায়। Pleura inflamed হলে breathing-এর সময় sharp chest pain হতে পারে।

### Learning logic

Pleural pain often worsens with deep breathing because inflamed pleural layers move against each other.

## 12. Fibrosis: Thickened Lung Tissue

**Fibrosis** হলো lung tissue বা alveolar wall thickening/scarring. এতে diffusion distance বাড়ে এবং gas exchange কমে যেতে পারে।

```text
Tissue scarring / thickening
  ↓
Alveolar-capillary membrane becomes less efficient
  ↓
O₂ diffusion decreases
  ↓
Shortness of breath may occur
```

## 13. Smoking Damage: One Flowchart

```text
Cigarette smoke / toxins / CO
  ↓
Cilia damage or paralysis
  ↓
Mucus clearance decreases
  ↓
Mucus and particles accumulate
  ↓
Bronchial inflammation increases
  ↓
Bronchitis / infection risk increases
...
শিক্ষার্থীদের জন্য important health literacy:

- শ্বাস নিতে কষ্ট হওয়া
- ঠোঁট/নখ নীল হয়ে যাওয়া
- chest pain
...
Respiratory disease আমাদের শেখায়: শরীরের ভেতরের অ্যালভিওলাই এবং বাইরে থাকা পরিবেশ আলাদা নয়। বাতাসে ধোঁয়া, ধূলা, জীবাণু, virus, poor ventilation, crowding, smoking—এসব সিদ্ধান্ত ও পরিবেশ respiratory physiology-র ওপর সরাসরি প্রভাব ফেলে। তাই “শ্বাস” শুধু biological act নয়; এটি environmental responsibility, personal discipline, social hygiene and ethical living-এর সাথে যুক্ত।

## 19. Critical Thinking Questions

1. Bronchitis ও pneumonia—দুইটিতেই cough হতে পারে। কিন্তু affected structure ও gas-exchange impact দিয়ে এদের পার্থক্য করো।
